...
<div class="tabbable-custom ">
	...
	<form:form id="searchForm" modelAttribute="act" action="${ctx}/act/task/todo/" method="get" class="breadcrumb form-search">
		<div>
			...
			<input id="beginDate"  name="beginDate"  type="text" readonly="readonly" maxlength="20" class="input-xxlarge Wdate" style="width:163px;"
				value="<fmt:formatDate value="${act.beginDate}" pattern="yyyy-MM-dd"/>"
					onclick="WdatePicker({dateFmt:'yyyy-MM-dd'});"/>
				　--　
			<input id="endDate" name="endDate" type="text" readonly="readonly" maxlength="20" class="input-xxlarge Wdate" style="width:163px;"
