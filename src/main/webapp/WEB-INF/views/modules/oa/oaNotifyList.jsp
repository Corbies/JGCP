...
<div class="tabbable-custom ">
	...
	<form:form id="searchForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/${oaNotify.self?'self':''}" method="post" cssClass="form-inline">
		<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
		<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
		<div class="form-group">
			<label>标题：</label>
			<form:input path="title" htmlEscape="true" maxlength="200" class="form-control"/>
		</div>
	<div class="form-group">
			<label>类型：</label>
			...
			<c:if test="${!requestScope.oaNotify.self}"><div class="form-group"><label>状态：</label>
	...
	<table id="contentTable" class="table table-striped table-bordered table-hover contentTable">
		<thead>
			<tr>
				<th>标题</th>
				<th>类型</th>
